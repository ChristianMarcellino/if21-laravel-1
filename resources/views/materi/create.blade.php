                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="pertemuan" type="text" class="form-control" name="pertemuan" value="{{old('pertemuan')}}">
                            @error('pertemuan')
                      ...
                      <div class="mb-3">
                        ...
                        <input id="pokok_bahasan" type="text" class="form-control" name="pokok_bahasan" value="{{old('pokok_bahasan')}}">
                        @error('pokok_bahasan')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
